...
public class FFTtest {
    ...
    public void test2(){
        ...
        double d1=ArrayAnalyser.findFreqComponent(input,1,7);
        double d1expected=1;
        assertEquals(d1expected,d1,0.001);
    }
    ...
    public void test3(){
        ...
        double d1=ArrayAnalyser.findBreathComponent(input);
        double d1expected=0.1012;
        assertEquals(d1expected,d1,0.001);
    }

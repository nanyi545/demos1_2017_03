...
public class AmapActivity1 extends AppCompatActivity {

    public static void start(Context c){
        Intent i=new Intent(c,AmapActivity1.class);
        c.startActivity(i);
    }
    ...
    public AMapLocationListener mLocationListener = new AMapLocationListener() {
        ...
        public void onLocationChanged(AMapLocation amapLocation) {
            Log.i("AMAP","location changed");
            showLocation.setText("location changed");
            ...
            if (amapLocation.getErrorCode() == 0) {
                ...
                showLocation.setText(address+"  "+city);

 ...
 */
public class CustomOffsetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public CustomOffsetBehavior() {}

    public CustomOffsetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

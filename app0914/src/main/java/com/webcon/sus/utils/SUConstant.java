...
//    public static final int COLOR_HEAD_GREY_SEC     = -8884100;   // BlueGrey 400   // color for defense/no-defense
//    public static final int COLOR_HEAD_GREY_SEC     = -14273992;   // BlueGrey 900
//    public static final int COLOR_HEAD_GREY_SEC     = -7297820;   // BlueGrey 300
//    public static final int COLOR_HEAD_GREY_SEC     = -5194043;   // BlueGrey 200
//    public static final int COLOR_HEAD_GREY_SEC     =-1552832;  // RED400
//    public static final int COLOR_HEAD_GREY_SEC     = -2039584;   // Grey 300
//    public static final int COLOR_HEAD_GREY_SEC     = -4342339;   // Grey 400
//    public static final int COLOR_HEAD_GREY_SEC     = -6381922;   // Grey 500
    public static final int COLOR_HEAD_GREY_SEC     = -5395027;   // Grey 450  //  11-19 use this color
    ...
    public static final short DEVICE_PDU_TYPE_MONITOR   = 1;
    public static final short DEVICE_PDU_TYPE_RADAR     = 2;
    ...
    /** 开启布防回复*/
    public static final short SUB_RESPOND_OPEN_DEFENCE  = 10010;

    /** 停止布防请求 */
    public static final short SUB_REQUEST_STOP_DEFENCE  = 10011;
    /** 停止布防回复 */
    public static final short SUB_RESPOND_STOP_DEFENCE  = 10012;

    /** 播放报警语音请求  **没有关闭的请求  */
    public static final short SUB_REQUEST_ALARM_PLAYER  = 10013;

    /** 播放喊话请求  **没有关闭的请求 **也不需要返回值 */    //-->9-18 加入返回值
    public static final short SUB_REQUEST_SPEAKER       = 10015;

    /** 播放喊话请求(首次请求)  **没有关闭的请求 **也不需要返回值 */
    public static final short SUB_1ST_REQ_SPEAKER       = 10031;
    /** 播放喊话请求(首次请求)的回复  */
    public static final short SUB_RESP_SPEAKER      = 10033;
    /** 停止喊话请求 **/
    public static final short SUB_LAST_REQ_SPEAKER    =10032;
    /** 停止喊话回复 **/
    public static final short SUB_LAST_RES_SPEAKER    =10053;

    /** 报警处理状态修改，一般是别人处理了，在这个手机更新 */
    public static final short SUB_RESPOND_ALARM_UPDATE=10024;


    /**  添加摄像头  */
    public static final short PDU_AddDevice_REQ_FROMPC=10050;
    /**  删除摄像头  */
    public static final short PDU_DelDevice_REQ_FROMPC=10052;
    ...
    /** 获取战场请求（报警） */
    public static final short SUB_REQUEST_GET_ALARMS    = 10029; // 09-15 changed from 10021 to 10029
    /** 报警消息处理请求 */
    public static final short SUB_REQUEST_PROCESS_ALARM = 10024;
    /** 向站场注册/反注册的请求 */
    public static final short SUB_REQUEST_REGISTER      = 10026;
    /** 请求报警图片 */
    public static final short SUB_REQUEST_ALARM_IMAGE   = 10027;
    ...
    /** 报警图片请求结果 */
    public static final short SUB_RSP_ALARM_IMAGE       = 10028;
    ...
    /** 状态：停止 */
    public static final int PTZ_STATE_STAY      = 1;     //  9-18 改成1停止 0运动，---之前是0停止1运动
    /** 状态：运动 */
    public static final int PTZ_STATE_MOVING    = 0;
    ...
    /* 报警抓拍图片格式 */
    /** 无压缩 */
    public static final short CAPTRUE_PICTYPE_UNCOMPRESSED  = 0;
    /** JPG格式 */
    public static final short CAPTURE_PICTYPE_JPG           = 1;
    /** BMP格式 */
    public static final short CAPTURE_PICTYPE_BMP           = 2;
    /** PNG格式 */
    public static final short CAPTURE_PICTYPE_PNG           = 3;


    /* 位置信息 */
    /** 段位信息 */
    public static final short POSITION_MSG_TYPE_SEGMENT     = 0;
    /** 角度信息 */
    public static final short POSITION_MSG_TYPE_ANGLE       = 1;

    /* 报警消息处理回复/通知结果 */
    /** 报警消息处理请求失败 */
    public static final int ALARM_FLAG_SOLVED_FAIL          = 0;
    /** 报警消息处理请求成功 */
    public static final int ALARM_FLAG_SOLVED_SUCCESS       = 1;
    /** 报警消息已处理通知 */
    public static final int ALARM_FLAG_SOLVED_NOTIFY        = 2;

...
public class AudioUtils {
    ...
    public static final String WAV_FILE_O = FILEPATH + "Uncoded.pcm";
...
//    public static final int CHANNEL_CONFIG = AudioFormat.CHANNEL_IN_STEREO;
    ...
    /** 录音缓冲区大小 ----读取缓冲区大小决定读取频率，采样频率一定情况下，缓冲区越大，读取频率越小*/
    public static final int RECORD_BUFFER_SIZE  = 640;  // 原来640 ----9-18, //20ms一个包的情况下，缓冲区大小应该是640
    /** 读取缓冲区大小 */

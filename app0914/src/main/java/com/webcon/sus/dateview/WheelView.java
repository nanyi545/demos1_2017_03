...
package com.webcon.sus.dateview;
...
public class WheelView extends View {
	...
	private String buildText(boolean useCurrentValue) {
		...
		for (int i = currentItem - addItems; i <= currentItem + addItems; i++) {
			if (useCurrentValue || i != currentItem) {
				...
				if (text != null) {
					try {
						itemsText.append(PublicMethodUtil.getInstance().makeDoubleNumber(text));
					} catch (Exception e) {
	...
	private void createLayouts(int widthItems, int widthLabel) {
		...
		if (!isScrollingPerformed
			...
			String text;
			try {
				text = getAdapter() != null ? PublicMethodUtil.getInstance()
						.makeDoubleNumber(getAdapter().getItem(currentItem)) : null;
			} catch (Exception e) {
